  ...
  render() {
    let renderIcon = () => {
      if (RkTheme.current.name === 'light')
        return <Image style={styles.image} source={require('../../assets/images/logo2.png')}/>;
    ...
    return (
      <RkAvoidKeyboard
        ...
        <View style={styles.header}>
          {renderIcon()}
          <RkText rkType='light h1'>eJuice Calculator</RkText>
          <RkText rkType='logo h0'>Dan Test</RkText>
        </View>
        <View style={styles.content}>
          ...
          }} rkType='large' style={styles.button} text='LOGIN'/>
          </View>
